 ...
 * Here's a quick FAQ.
 *
 * @section why_another_server WHY another server ?
 ...
 * standards.
 *
 * @section why_cpp Why bother using C++ ?
 ...
 *
 * @section why_opensource Why making it Open-Source ?
 ...
 * all 1.8 versions.
 *
 * @section what_features What features do you have compared to other ?
 ...
 *    of the project)
 *
 * @section why_so_long Why does the project takes so much time ?
 ...
 *
 * @section faq_end_note End note with a touch of existential crisis
